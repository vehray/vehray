    ...
    ldfEditor: {
      ...
      frameEditor: {
        ...
        signalEditor: {
          ...
          valueRaw: '数值(十六进制)',
          description: '描述',
          rightClickToCreateValueDescription: '在此处右键新建数值描述',
          ...
          contextMenu: {
            newValueDescription: '新建',
            deleteValueDescription: '删除',
            newMultiRangeParam: '新建',
            deleteMultiRangeParam: '删除'
          }
        }
      },
      scheduleEditor: {
